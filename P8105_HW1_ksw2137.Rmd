...
Using the commands `as.numeric()` seems to show a numeric value that represents each element in the vectors. While the logical vector shows 0/1, character vector shows NA indicating that it doesn't have a numeric representation. Factor vectors however, show numbers 1-3 but calculating the mean indicates that the argument isn't numeric/logical. Likely because 1-3 is only used as a "category". 
